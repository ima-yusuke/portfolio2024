<div class="w-full h-full bg-work-light-yellow rounded-md pl-4 md:pl-16 pt-2 pr-2 flex flex-col gap-6 @if($flag===false) hide @endif" id="container_{{$category}}_menu">
