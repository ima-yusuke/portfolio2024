{{--モダルopen時の背景黒幕--}}
<div class="hide fixed min-h-screen w-full flex flex-col justify-center items-center bg-black -z-10" id="{{$name}}_modal">
    {{--モダルコンテナ--}}
    <div class="w-[80%] flex flex-col items-center justify-center relative rounded-md">
        ...
        <img src="{{asset($src)}}" class="w-full h-[750px] object-cover">
    </div>
</div>
